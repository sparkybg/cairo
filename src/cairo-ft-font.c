	...
	cairo_scaled_font_t** font_out)
{
	...
	printf("_cairo_ft_font_face_scaled_font_create(), Round(IN):%d\n", options->round_glyph_positions); //sparky
	...
	printf("_cairo_ft_font_face_scaled_font_create(), Round(FT):%d\n", scaled_font->ft_options.base.round_glyph_positions); //sparky
